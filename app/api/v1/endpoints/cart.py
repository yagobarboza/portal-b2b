...
async def _company_purchase_rules(db: AsyncSession) -> tuple[Decimal | None, int | None]:
    """Carrega as regras de compra da empresa (tenant) do usuário logado."""
    ...
    if not company:
        return None, None
    return company.min_order_value, company.min_order_quantity
